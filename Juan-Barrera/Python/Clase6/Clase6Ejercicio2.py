...
# Hacer un programa que simule una agenda de contactor. Crear un diccionario donde la clave sea el nombre de usuario y el valor sea del telefono, el programa tendra el siguiente menu de opciones
# 1. Nuevo contacto
# 2. Borrar contacto
