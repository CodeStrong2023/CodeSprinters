...
# Hacer un ejercicio que simule un cajero automatico con un saldo
...
while True:
    ...
    print("4. Salir")
    opcion = int(input("Digite una opcio del menu: "))
    print()
    if opcion == 1:
        ...
        print("Gracias por usar su cajero automatico, hasta pronto")
        break
    else:
